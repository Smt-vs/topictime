...
export function TopicTimeApp() {
  ...
  async function copyRoomInvite() {
    const inviteUrl = `${window.location.origin}/applicativo?room=${selectedRoom.id}`;
        ...
        <section className="login-card" aria-labelledby="login-title">
          <div className="login-copy">
            ...
            <div className="hero-actions">
              ...
              <Link className="secondary-action" href="/applicativo/support">
                Serve aiuto?
              </Link>
            </div>
          </div>
    ...
    <main className="topic-app" data-theme={profile.selectedThemeId}>
      <aside className="sidebar" aria-label="Navigazione TopicTime">
        ...
        <nav className="side-nav">
          ...
          <Link href="/applicativo/radar">
            <Wand2 size={18} />
            Radar
          </Link>
          <Link href="/applicativo/support">
            <ShieldAlert size={18} />
            Supporto
          </Link>
        </nav>
