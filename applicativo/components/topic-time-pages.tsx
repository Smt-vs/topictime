...
const navItems: { href: string; icon: LucideIcon; id: PageKey; label: string }[] = [
  ...
  { href: "/applicativo", icon: Hash, id: "rooms", label: "Stanze" },
  { href: "/applicativo/wallet", icon: Coins, id: "wallet", label: "Star" },
  { href: "/applicativo/community", icon: MessageCircle, id: "community", label: "Community" },
  { href: "/applicativo/profile", icon: Users, id: "profile", label: "Profilo" },
  { href: "/applicativo/radar", icon: Eye, id: "radar", label: "Radar" },
  { href: "/applicativo/support", icon: ShieldAlert, id: "support", label: "Supporto" },
];
...
function ProductNav({ current }: { current: PageKey }) {
  return (
    <header className="product-nav" aria-label="Navigazione principale">
      ...
      <Link className="nav-cta" href="/applicativo?auth=login">
        Accedi
      </Link>
    </header>
  );
      ...
      <section className="landing-hero">
        <div className="hero-copy-block">
          ...
          <div className="hero-actions">
            <Link className="primary-action" href="/applicativo?auth=register"><MessageCircle size={18} />Crea account gratis</Link>
    ...
    <PageShell
      ...
      actions={
        <>
          ...
          <Link className="secondary-action" href="/applicativo/support">Hai bisogno di aiuto?</Link>
        </>
      }
    >
...
export function ProfilePage() {
  return (
    <PageShell
      ...
      actions={
        <>
          <Link className="primary-action" href="/applicativo?auth=register">Crea il tuo profilo</Link>
          <Link className="secondary-action" href="/applicativo/radar">Scopri il Radar</Link>
        </>
      }
    >
    ...
    <PageShell
      ...
      actions={
        <>
          ...
          <Link className="secondary-action" href="/applicativo/profile">Come funziona il profilo</Link>
        </>
      }
    >
...
export function SupportPage() {
  return (
    <PageShell
      ...
      actions={
        <>
          <Link className="primary-action" href="/applicativo?auth=login">Torna alle stanze</Link>
